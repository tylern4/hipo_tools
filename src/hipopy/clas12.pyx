...
cdef class clas12Event:
  cdef:
    ...
    bool _loaded_cal
    # EC
    ndarray _ec_tot_energy
    ndarray _ec_pcal_energy
    ndarray _ec_pcal_sec
    ndarray _ec_pcal_time
    ndarray _ec_pcal_path
    ndarray _ec_pcal_x
    ndarray _ec_pcal_y
    ndarray _ec_pcal_z
    ndarray _ec_pcal_lu
    ndarray _ec_pcal_lv
    ndarray _ec_pcal_lw
    ndarray _ec_ecin_energy
    ndarray _ec_ecin_sec
    ndarray _ec_ecin_time
    ndarray _ec_ecin_path
    ndarray _ec_ecin_x
    ndarray _ec_ecin_y
    ndarray _ec_ecin_z
    ndarray _ec_ecin_lu
    ndarray _ec_ecin_lv
    ndarray _ec_ecin_lw
    ndarray _ec_ecout_energy
    ndarray _ec_ecout_sec
    ndarray _ec_ecout_time
    ndarray _ec_ecout_path
    ndarray _ec_ecout_x
    ndarray _ec_ecout_y
    ndarray _ec_ecout_z
    ndarray _ec_ecout_lu
    ndarray _ec_ecout_lv
    ndarray _ec_ecout_lw

    # SC
    ndarray _sc_ftof_1a_sec
    ndarray _sc_ftof_1a_time
    ndarray _sc_ftof_1a_path
    ndarray _sc_ftof_1a_energy
    ndarray _sc_ftof_1a_component
    ndarray _sc_ftof_1a_x
    ndarray _sc_ftof_1a_y
    ndarray _sc_ftof_1a_z
    ndarray _sc_ftof_1a_hx
    ndarray _sc_ftof_1a_hy
    ndarray _sc_ftof_1a_hz
    ndarray _sc_ftof_1b_sec
    ndarray _sc_ftof_1b_time
    ndarray _sc_ftof_1b_path
    ndarray _sc_ftof_1b_energy
    ndarray _sc_ftof_1b_component
    ndarray _sc_ftof_1b_x
    ndarray _sc_ftof_1b_y
    ndarray _sc_ftof_1b_z
    ndarray _sc_ftof_1b_hx
    ndarray _sc_ftof_1b_hy
    ndarray _sc_ftof_1b_hz
    ndarray _sc_ftof_2_sec
    ndarray _sc_ftof_2_time
    ndarray _sc_ftof_2_path
    ndarray _sc_ftof_2_energy
    ndarray _sc_ftof_2_component
    ndarray _sc_ftof_2_x
    ndarray _sc_ftof_2_y
    ndarray _sc_ftof_2_z
    ndarray _sc_ftof_2_hx
    ndarray _sc_ftof_2_hy
    ndarray _sc_ftof_2_hz
    ndarray _sc_ctof_time
    ndarray _sc_ctof_path
    ndarray _sc_ctof_energy
    ndarray _sc_ctof_component
    ndarray _sc_ctof_x
    ndarray _sc_ctof_y
    ndarray _sc_ctof_z
    ndarray _sc_ctof_hx
    ndarray _sc_ctof_hy
    ndarray _sc_ctof_hz
    ndarray _sc_cnd_time
    ndarray _sc_cnd_path
    ndarray _sc_cnd_energy
    ndarray _sc_cnd_component
    ndarray _sc_cnd_x
    ndarray _sc_cnd_y
    ndarray _sc_cnd_z
    ndarray _sc_cnd_hx
    ...
    # CC
    ndarray _cc_nphe_tot
    ndarray _cc_ltcc_sec
    ndarray _cc_ltcc_nphe
    ndarray _cc_ltcc_time
    ndarray _cc_ltcc_path
    ndarray _cc_ltcc_theta
    ndarray _cc_ltcc_phi
    ndarray _cc_htcc_sec
    ndarray _cc_htcc_nphe
    ndarray _cc_htcc_time
    ndarray _cc_htcc_path
    ndarray _cc_htcc_theta
    ndarray _cc_htcc_phi
    ndarray _cc_rich_sec
    ndarray _cc_rich_nphe
    ndarray _cc_rich_time
    ndarray _cc_rich_path
    ndarray _cc_rich_theta
    ndarray _cc_rich_phi
    # FT
    ndarray _ft_cal_energy
    ndarray _ft_cal_time
    ndarray _ft_cal_path
    ndarray _ft_cal_x
    ndarray _ft_cal_y
    ndarray _ft_cal_z
    ndarray _ft_cal_dx
    ndarray _ft_cal_dy
    ndarray _ft_cal_radius
    ndarray _ft_hodo_energy
    ndarray _ft_hodo_time
    ndarray _ft_hodo_path
    ndarray _ft_hodo_x
    ndarray _ft_hodo_y
    ndarray _ft_hodo_z
    ndarray _ft_hodo_dx
    ndarray _ft_hodo_dy
    ndarray _ft_hodo_radius
  ...
  def __cinit__(clas12Event self, string filename):
    ...
    self._loaded_ft = False
    self._loaded_trk = False
    self._loaded_cc = False
    self._loaded_sc = False
    self._loaded_cal = False
